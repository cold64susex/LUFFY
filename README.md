...
- [ ] **luffy/verl/verl/trainer/fsdp_sft_trainer.py:16** - - Add calculation of mfu - Add validation
...
- [ ] **luffy/verl/verl/utils/torch_functional.py:171** - optimize this. Technically, we only need one broadcast
